   ...
   const ZONES = [

    {
      ...
      blurb: {
        ...
        ka: 'ახაშენი წითელი, ბუნებრივად ნახევრადტკბილი ღვინოა და შეიძლება დამზადდეს მხოლოდ საფერავის ჯიშის ყურძნიდან. ღვინო ხასიათდება მუქი ლალისფერი შეფერვით, ჰარმონიული, ხავედორვანი სიტკბოთი, ხილის ტონებით და ჯიშური არომატით. ყურძნის  მოსავალი 1 ჰექტარ ვენახზე არ უნდა აღემატებოდეს 10 ტონას. ღვინის გამოსავალი არ უნდა აღემატებოდეს 650 ლიტრს  ერთი ტონა ყურძნიდან.'
      },
